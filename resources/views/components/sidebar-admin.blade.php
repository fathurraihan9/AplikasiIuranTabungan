                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.pembayaran_iuran') }}"
                                class="nav-link {{ Route::is('admin.pembayaran_iuran') ? 'active' : '' }} {{ Auth::guard('user')->user()->role == 'admin' ? 'd-flex' : 'd-none' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.setoran_tabungan') }}"
                                class="nav-link {{ Route::is('admin.setoran_tabungan') ? 'active' : '' }} {{ Auth::guard('user')->user()->role == 'admin' ? 'd-flex' : 'd-none' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Setoran</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.penarikan_tabungan') }}"
                                class="nav-link {{ Route::is('admin.penarikan_tabungan') ? 'active' : '' }} {{ Auth::guard('user')->user()->role == 'admin' ? 'd-flex' : 'd-none' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Tarik Tabungan</p>
                            </a>
                        </li>
